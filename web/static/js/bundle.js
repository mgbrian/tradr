(() => {
  ...
  var require_grpc_web = __commonJS({
    "node_modules/grpc-web/index.js"(exports, module) {
      var n;
      function aa(a) {
        var b = 0;
        return function() {
      ...
      tb.prototype.add = function(a, b, c, d, f) {
        ...
        a || (a = this.a[g] = [], this.b++);
        var e = ub(a, b, d, f);
        -1 < e ? (b = a[e], c || (b.D = false)) : (b = new rb(b, this.src, g, !!d, f), b.D = c, a.push(b));
        return b;
      };
      tb.prototype.remove = function(a, b, c, d) {
        a = a.toString();
        if (!(a in this.a)) return false;
        var f = this.a[a];
        b = ub(f, b, c, d);
        return -1 < b ? (sb(f[b]), Array.prototype.splice.call(f, b, 1), 0 == f.length && (delete this.a[a], this.b--), true) : false;
      };
      function vb(a, b) {
        var c = b.type;
        if (c in a.a) {
      ...
      function zb(a, b, c, d, f) {
        ...
        else c = Bb(c), a && a[M] ? a.f.add(String(b), c, false, sa(d) ? !!d.capture : !!d, f) : Cb(a, b, c, false, d, f);
      }
      function Cb(a, b, c, d, f, g) {
        ...
        if (!c.proxy) {
          ...
          d.src = a;
          d.listener = c;
          if (a.addEventListener) ob || (f = e), void 0 === f && (f = false), a.addEventListener(b.toString(), d, f);
      ...
      function Ab(a, b, c, d, f) {
        ...
        else c = Bb(c), a && a[M] ? a.f.add(String(b), c, true, sa(d) ? !!d.capture : !!d, f) : Cb(a, b, c, true, d, f);
      }
      ...
      function ec(a) {
        var b;
        (b = a.a) || (b = {}, fc(a) && (b[0] = true, b[1] = true), b = a.a = b);
        return b;
      }
      var gc;
      function hc() {
      ...
      n.delete = function(a) {
        return U(this.o, a) ? (delete this.o[a], --this.size, this.B++, this.j.length > 2 * this.size && pc(this), true) : false;
      };
      function pc(a) {
      ...
      function vc(a, b, c) {
        ...
        try {
          xc(a), 0 < a.h && (a.I = yc(a.a), P(a.b, V(a, "Will abort after " + a.h + "ms if incomplete, xhr2 " + a.I)), a.I ? (a.a.timeout = a.h, a.a.ontimeout = z(a.T, a)) : a.w = Mb(a.T, a.h, a)), P(a.b, V(a, "Sending request")), a.s = true, a.a.send(b), a.s = false;
        } catch (g) {
          P(
            a.b,
      ...
      n.abort = function(a) {
        this.a && this.c && (P(this.b, V(this, "Aborting")), this.c = false, this.i = true, this.a.abort(), this.i = false, this.g = a || 7, O(this, "complete"), O(this, "abort"), Ac(this));
      };
      n.R = function() {
      ...
      function X(a) {
        ...
        zb(this.a, "complete", function() {
          ...
          } else c = false, "grpc-status" in e && (d = Number(e["grpc-status"]), "grpc-message" in e && (f = e["grpc-message"]), 0 != d && (Y(b, new E(d, f || "", e)), c = true)), c || Lc(b);
        });
      }
  ...
  var require_google_protobuf = __commonJS({
    "node_modules/google-protobuf/google-protobuf.js"(exports) {
      ...
      function Ha(a) {
        ...
        else if (34028234663852886e22 < a) z = 0, y = (b << 31 | 2139095040) >>> 0;
        else if (11754943508222875e-54 > a) a = Math.round(a / Math.pow(2, -149)), z = 0, y = (b << 31 | a) >>> 0;
        else {
      ...
      function Ia(a) {
        ...
        else if (17976931348623157e292 < a) z = (b << 31 | 2146435072) >>> 0, y = 0;
        else if (22250738585072014e-324 > a) a /= Math.pow(2, -1074), z = (b << 31 | a / 4294967296) >>> 0, y = a >>> 0;
        else {
          var c = a, d = 0;
      ...
      function ob(a, b) {
        ...
        for (d in a) c[d] = 0;
        for (d in b) c[d] = 0;
        for (d in c) if (!nb(a[d], b[d])) return false;
        return true;
      }
      N.compareExtensions = ob;
      function nb(a, b) {
        if (a == b) return true;
        if (!la(a) || !la(b)) return "number" === typeof a && isNaN(a) || "number" === typeof b && isNaN(b) ? String(a) == String(b) : false;
        ...
        if (a.constructor === Array) {
          ...
          return d || f ? (d = d || {}, f = f || {}, ob(d, f)) : true;
        }
      ...
      "object" === typeof exports && (exports.debug = R, exports.Map = r, exports.Message = N, exports.BinaryReader = J, exports.BinaryWriter = W, exports.ExtensionFieldInfo = Ya, exports.ExtensionFieldBinaryInfo = Za, exports.exportSymbol = ma, exports.inherits = na, exports.object = { extend: pa }, exports.typeOf = k);
    }
  });

  // src/protos/service_pb.js
  var require_service_pb = __commonJS({
    "src/protos/service_pb.js"(exports) {
      ...
      goog.exportSymbol("proto.tradr.GetOrderRequest", null, global2);
      goog.exportSymbol("proto.tradr.GetPositionsRequest", null, global2);
      goog.exportSymbol("proto.tradr.GetPositionsResponse", null, global2);
      goog.exportSymbol("proto.tradr.ListFillsRequest", null, global2);
      ...
      goog.exportSymbol("proto.tradr.PlaceStockOrderRequest", null, global2);
      goog.exportSymbol("proto.tradr.PositionRecord", null, global2);
      ...
      if (jspb.Message.GENERATE_TO_OBJECT) {
        ...
        proto.tradr.PlaceOptionOrderRequest.toObject = function(includeInstance, msg) {
          var f, obj = {
            ...
            strike: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0),
      ...
      if (jspb.Message.GENERATE_TO_OBJECT) {
        ...
        proto.tradr.OrderRecord.toObject = function(includeInstance, msg) {
          var f, obj = {
            ...
            avgPrice: jspb.Message.getFloatingPointFieldWithDefault(msg, 8, 0),
        ...
        proto.tradr.ListOrdersResponse.toObject = function(includeInstance, msg) {
          var f, obj = {
            ordersList: jspb.Message.toObjectList(
              msg.getOrdersList(),
              proto.tradr.OrderRecord.toObject,
              includeInstance
            )
          };
          if (includeInstance) {
      ...
      proto.tradr.ListOrdersResponse.prototype.getOrdersList = function() {
        return (
          /** @type{!Array<!proto.tradr.OrderRecord>} */
      ...
      if (jspb.Message.GENERATE_TO_OBJECT) {
        ...
        proto.tradr.FillRecord.toObject = function(includeInstance, msg) {
          var f, obj = {
            ...
            price: jspb.Message.getFloatingPointFieldWithDefault(msg, 4, 0),
      ...
      if (jspb.Message.GENERATE_TO_OBJECT) {
        ...
        proto.tradr.ListFillsResponse.toObject = function(includeInstance, msg) {
          var f, obj = {
            fillsList: jspb.Message.toObjectList(
              msg.getFillsList(),
              proto.tradr.FillRecord.toObject,
              includeInstance
            )
          };
          if (includeInstance) {
      ...
      proto.tradr.ListFillsResponse.prototype.getFillsList = function() {
        return (
          /** @type{!Array<!proto.tradr.FillRecord>} */
      ...
      if (jspb.Message.GENERATE_TO_OBJECT) {
        ...
        proto.tradr.PositionRecord.toObject = function(includeInstance, msg) {
          var f, obj = {
            ...
            position: jspb.Message.getFloatingPointFieldWithDefault(msg, 6, 0),
            avgCost: jspb.Message.getFloatingPointFieldWithDefault(msg, 7, 0)
          };
          if (includeInstance) {
            obj.$jspbMessageInstance = msg;
          }
      ...
      proto.tradr.PositionRecord.prototype.getPosition = function() {
        return (
          /** @type {number} */
          jspb.Message.getFloatingPointFieldWithDefault(this, 6, 0)
        );
      };
        ...
        proto.tradr.GetPositionsResponse.toObject = function(includeInstance, msg) {
          var f, obj = {
            positionsList: jspb.Message.toObjectList(
              ...
              proto.tradr.PositionRecord.toObject,
              includeInstance
            )
          };
          if (includeInstance) {
      ...
      proto.tradr.GetPositionsResponse.prototype.getPositionsList = function() {
        return (
          /** @type{!Array<!proto.tradr.PositionRecord>} */
      ...
      if (jspb.Message.GENERATE_TO_OBJECT) {
        ...
        proto.tradr.GetAccountValuesResponse.toObject = function(includeInstance, msg) {
          var f, obj = {
            accountValuesList: jspb.Message.toObjectList(
              msg.getAccountValuesList(),
              proto.tradr.AccountValueRecord.toObject,
              includeInstance
            )
          };
          if (includeInstance) {
      ...
      proto.tradr.GetAccountValuesResponse.prototype.getAccountValuesList = function() {
        return (
          /** @type{!Array<!proto.tradr.AccountValueRecord>} */
  ...
  // src/protos/service_grpc_web_pb.js
  var require_service_grpc_web_pb = __commonJS({
    "src/protos/service_grpc_web_pb.js"(exports, module) {
      var grpc = {};
      grpc.web = require_grpc_web();
      var proto2 = {};
      proto2.tradr = require_service_pb();
      proto2.tradr.TradingServiceClient = function(hostname, credentials, options) {
        if (!options) options = {};
        options.format = "text";
        this.client_ = new grpc.web.GrpcWebClientBase(options);
        this.hostname_ = hostname.replace(/\/+$/, "");
      };
      proto2.tradr.TradingServicePromiseClient = function(hostname, credentials, options) {
        if (!options) options = {};
        options.format = "text";
        this.client_ = new grpc.web.GrpcWebClientBase(options);
        this.hostname_ = hostname.replace(/\/+$/, "");
      };
      var methodDescriptor_TradingService_PlaceStockOrder = new grpc.web.MethodDescriptor(
        "/tradr.TradingService/PlaceStockOrder",
        grpc.web.MethodType.UNARY,
        proto2.tradr.PlaceStockOrderRequest,
        proto2.tradr.PlaceOrderResponse,
        /**
        ...
        proto2.tradr.PlaceOrderResponse.deserializeBinary
      );
      proto2.tradr.TradingServiceClient.prototype.placeStockOrder = function(request, metadata, callback) {
        return this.client_.rpcCall(
          this.hostname_ + "/tradr.TradingService/PlaceStockOrder",
          request,
          metadata || {},
      ...
      proto2.tradr.TradingServicePromiseClient.prototype.placeStockOrder = function(request, metadata) {
      ...
      var methodDescriptor_TradingService_PlaceOptionOrder = new grpc.web.MethodDescriptor(
        "/tradr.TradingService/PlaceOptionOrder",
        grpc.web.MethodType.UNARY,
        proto2.tradr.PlaceOptionOrderRequest,
        proto2.tradr.PlaceOrderResponse,
        /**
      ...
      proto2.tradr.TradingServiceClient.prototype.placeOptionOrder = function(request, metadata, callback) {
        return this.client_.rpcCall(
          this.hostname_ + "/tradr.TradingService/PlaceOptionOrder",
          request,
          metadata || {},
      ...
      proto2.tradr.TradingServicePromiseClient.prototype.placeOptionOrder = function(request, metadata) {
        return this.client_.unaryCall(
          this.hostname_ + "/tradr.TradingService/PlaceOptionOrder",
          request,
          metadata || {},
      ...
      var methodDescriptor_TradingService_GetOrder = new grpc.web.MethodDescriptor(
        ...
        grpc.web.MethodType.UNARY,
        proto2.tradr.GetOrderRequest,
        proto2.tradr.OrderRecord,
        /**
        ...
        proto2.tradr.OrderRecord.deserializeBinary
      );
      proto2.tradr.TradingServiceClient.prototype.getOrder = function(request, metadata, callback) {
        return this.client_.rpcCall(
          this.hostname_ + "/tradr.TradingService/GetOrder",
          request,
          metadata || {},
      ...
      proto2.tradr.TradingServicePromiseClient.prototype.getOrder = function(request, metadata) {
        return this.client_.unaryCall(
          this.hostname_ + "/tradr.TradingService/GetOrder",
          request,
          metadata || {},
      ...
      var methodDescriptor_TradingService_ListOrders = new grpc.web.MethodDescriptor(
        "/tradr.TradingService/ListOrders",
        grpc.web.MethodType.UNARY,
        proto2.tradr.ListOrdersRequest,
        proto2.tradr.ListOrdersResponse,
        /**
        ...
        proto2.tradr.ListOrdersResponse.deserializeBinary
      );
      proto2.tradr.TradingServiceClient.prototype.listOrders = function(request, metadata, callback) {
        return this.client_.rpcCall(
          this.hostname_ + "/tradr.TradingService/ListOrders",
          request,
          metadata || {},
      ...
      proto2.tradr.TradingServicePromiseClient.prototype.listOrders = function(request, metadata) {
        return this.client_.unaryCall(
          this.hostname_ + "/tradr.TradingService/ListOrders",
          request,
          metadata || {},
      ...
      var methodDescriptor_TradingService_ListFills = new grpc.web.MethodDescriptor(
        "/tradr.TradingService/ListFills",
        grpc.web.MethodType.UNARY,
        proto2.tradr.ListFillsRequest,
        proto2.tradr.ListFillsResponse,
        /**
        ...
        proto2.tradr.ListFillsResponse.deserializeBinary
      );
      proto2.tradr.TradingServiceClient.prototype.listFills = function(request, metadata, callback) {
        return this.client_.rpcCall(
          this.hostname_ + "/tradr.TradingService/ListFills",
          request,
          metadata || {},
      ...
      proto2.tradr.TradingServicePromiseClient.prototype.listFills = function(request, metadata) {
        return this.client_.unaryCall(
          this.hostname_ + "/tradr.TradingService/ListFills",
          request,
          metadata || {},
      ...
      var methodDescriptor_TradingService_GetPositions = new grpc.web.MethodDescriptor(
        "/tradr.TradingService/GetPositions",
        grpc.web.MethodType.UNARY,
        proto2.tradr.GetPositionsRequest,
        proto2.tradr.GetPositionsResponse,
        /**
        ...
        proto2.tradr.GetPositionsResponse.deserializeBinary
      );
      proto2.tradr.TradingServiceClient.prototype.getPositions = function(request, metadata, callback) {
        return this.client_.rpcCall(
          this.hostname_ + "/tradr.TradingService/GetPositions",
          request,
          metadata || {},
      ...
      proto2.tradr.TradingServicePromiseClient.prototype.getPositions = function(request, metadata) {
        return this.client_.unaryCall(
          this.hostname_ + "/tradr.TradingService/GetPositions",
          request,
          metadata || {},
      ...
      var methodDescriptor_TradingService_GetAccountValues = new grpc.web.MethodDescriptor(
        "/tradr.TradingService/GetAccountValues",
        grpc.web.MethodType.UNARY,
        proto2.tradr.GetAccountValuesRequest,
        proto2.tradr.GetAccountValuesResponse,
        /**
        ...
        proto2.tradr.GetAccountValuesResponse.deserializeBinary
      );
      proto2.tradr.TradingServiceClient.prototype.getAccountValues = function(request, metadata, callback) {
        return this.client_.rpcCall(
          this.hostname_ + "/tradr.TradingService/GetAccountValues",
          request,
          metadata || {},
      ...
      proto2.tradr.TradingServicePromiseClient.prototype.getAccountValues = function(request, metadata) {
        return this.client_.unaryCall(
          this.hostname_ + "/tradr.TradingService/GetAccountValues",
          request,
          metadata || {},
      ...
      module.exports = proto2.tradr;
    }
  });

  // src/client_web.js
  var svc = require_service_grpc_web_pb();
  var messages = require_service_pb();
  ...
  var TradingWebClient = class {
    ...
    constructor(baseUrl, opts) {
      ...
      this.client = new svc.TradingServicePromiseClient(this.baseUrl, null, {
        format
        // maps to mode=grpcwebtext or grpcweb when generated
      });
    }
    // --- Orders ---
    /**
     ...
     */
    async PlaceStockOrder(symbol, side, quantity, orderType = "MKT", price, tif = "DAY") {
      ...
      if (price !== void 0 && price !== null) req.setPrice(Number(price));
     ...
     * @returns {Promise<{order_id:number, broker_order_id:number, status:string, message:string}>}
     */
    async PlaceOptionOrder(symbol, expiry, strike, right, side, quantity, orderType = "MKT", price, tif = "DAY") {
    ...
    async ModifyOrder(orderId, fields = {}) {
      ...
      req.setOrderId(Number(orderId));
      if (fields && fields.quantity !== void 0 && fields.quantity !== null) {
        req.setQuantity(Number(fields.quantity));
      }
      if (fields && fields.order_type !== void 0 && fields.order_type !== null) {
        req.setOrderType(String(fields.order_type));
      }
      if (fields && fields.price !== void 0 && fields.price !== null) {
        req.setPrice(Number(fields.price));
      }
      if (fields && fields.tif !== void 0 && fields.tif !== null) {
